...
import br.gov.jfrf.siga.sr.model.SrConfiguracaoBL;
import br.gov.jfrf.siga.sr.model.SrDisponibilidade;
import br.gov.jfrf.siga.sr.model.SrEquipe;
import br.gov.jfrf.siga.sr.model.SrGravidade;
...
import br.gov.jfrf.siga.sr.model.SrTipoAcao;
import br.gov.jfrf.siga.sr.model.SrTipoAtributo;
import br.gov.jfrf.siga.sr.model.SrTipoMotivoEscalonamento;
import br.gov.jfrf.siga.sr.model.SrTipoMotivoPendencia;
import br.gov.jfrf.siga.sr.model.SrTipoMovimentacao;
import br.gov.jfrf.siga.sr.model.SrTipoPergunta;
import br.gov.jfrf.siga.sr.model.SrTipoPermissaoLista;
import br.gov.jfrf.siga.sr.model.SrUrgencia;
import br.gov.jfrf.siga.sr.model.SrSolicitacao.SrTarefa;
import br.gov.jfrf.siga.sr.model.vo.PaginaItemConfiguracao;
import br.gov.jfrf.siga.sr.model.vo.SelecionavelVO;
import br.gov.jfrf.siga.sr.model.vo.SrSolicitacaoListaVO;
import br.gov.jfrf.siga.sr.util.AtualizacaoLista;
import br.gov.jfrf.siga.sr.util.SrSolicitacaoAtendidos;
import br.gov.jfrf.siga.sr.util.SrSolicitacaoFiltro;
import br.gov.jfrf.siga.sr.util.SrSolicitacaoItem;
